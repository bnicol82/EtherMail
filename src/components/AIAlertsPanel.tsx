      ...
      <div className="shrink-0 border-t border-[var(--glass-border)] bg-[var(--glass-bg)]/80 backdrop-blur-sm">
        <div className="flex items-center gap-1 px-3 py-2">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <span className="text-xs font-semibold text-theme shrink-0">AI Alerts</span>
            {unreadCount > 0 && (
              <span className="px-1.5 py-0.5 rounded-full bg-amber-500/25 text-amber-400 text-[10px] font-medium shrink-0">
                {unreadCount} new
              </span>
            )}
            {unreadCount > 0 && (
              <button
                ...
                className="text-[10px] text-accent hover:underline shrink-0 px-1.5 py-1 rounded-md hover-theme"
              >
                Mark all read
              </button>
            )}
          ...
          <button
            ...
            className="p-2.5 -mr-1 rounded-lg hover-theme text-theme-muted shrink-0"
