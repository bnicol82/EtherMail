...
export function NoteDetailsSheet({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end md:hidden" role="dialog" aria-modal="true">
      ...
      />
      <div className="relative glass-frost rounded-t-2xl border-t border-[var(--glass-border)] shadow-2xl max-h-[min(70vh,520px)] flex flex-col pb-[env(safe-area-inset-bottom)]">
        <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--glass-border)] shrink-0">
          <h3 className="text-sm font-semibold text-theme">Note details</h3>
          <button
            type="button"
            onClick={onClose}
